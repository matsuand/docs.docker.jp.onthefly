...
function walkTree(tree) {
    for (var j = 0; j < tree.length; j++) {
        ...
        if (tree[j].section) {
            ...
            outputLetNav.push('<li><a href="https://matsuand.github.io/docs.docker.jp.onthefly' + tree[j].path + '"')
...
function renderNav(docstoc) {
    for (var i = 0; i < docstoc.horizontalnav.length; i++) {
        ...
        outputHorzTabs.push('><a href="https://matsuand.github.io/docs.docker.jp.onthefly' + docstoc.horizontalnav[i].path + '">' + docstoc.horizontalnav[i].title + "</a></li>\n");
    }
