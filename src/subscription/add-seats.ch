...
@y
既存サブスクリプションに対しては、いつでもシートを追加することができます。
@z
...
> **メモ**
>
>- 月額サブスクリプションには、 月額でのシートしか含まれません。
>- 組織に対してシートを追加するには「所有者」チームのメンバーでなければなりません。
>- 月額サブスクリプションの支払い期間途中でシート追加を行った場合、追加シートに関しては日割り計算により請求が行われます。
@z

@x
To add seats to a monthly subscription:
@y
月額サブスクリプションにシートを追加するには、以下を行います。
@z
...
> **メモ**
>
> - 年額サブスクリプションには、 年額でのシートしか含まれません。
> - 年額サブスクリプションの支払い期間途中でシート追加を行った場合、追加シートに関しては日割り計算により請求が行われます。
@z

@x
To add annual seats to an annual subscription:
@y
年額サブスクリプションにシートを追加するには、以下を行います。
@z
