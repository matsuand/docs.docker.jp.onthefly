...
サブスクリプションへのシート追加は、以下のようにして行います。
@z
...
> **メモ**
>
>- 月額または年額サブスクリプションを追加すると、シートはそのサブスクリプション用になります。
>- 月額サブスクリプションの場合、組織に対してシートを追加するためには、「所有者」チームのメンバーでなければなりません。
>- 支払い期間途中でシート追加を行った場合、追加シートに関しては日割り計算により請求が行われます。
@z
