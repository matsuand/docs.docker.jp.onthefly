...
@y
最新版のダウンロード準備が整ったら **Download update**（最新版のダウンロード）をクリックします。
このダウンロードはバックグラウンドで実行されます。
ダウンロードが終わったら Docker メニューから **Update and restart**（更新と再起動）をクリックします。
最新版がインストールされて、これを有効にするため Docker Desktop が再起動されます。
@z
