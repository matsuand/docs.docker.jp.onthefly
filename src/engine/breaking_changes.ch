...
page.
@y
どのような場合でも将来的に削除する予定の機能は、前もって 3 リリースの期間は議論を継続し、[廃止機能]({{ site.baseurl }}/engine/deprecated/) において文書化しています。
@z
...
> **メモ**
>
> お手元のローカル環境において [Docker Desktop for Mac](../desktop/mac/index.md) や [Docker Desktop for Windows](../desktop/windows/index.md) を利用している場合は、Docker Engine のアップデートが必要です。
