...
> **廃止決定**
>
> Docker Machine は廃止決定されています。
> これに代わって Docker Desktop を利用してください。
> [Docker Desktop for Mac](../desktop/mac/index.md) または [Docker Desktop for Windows](../desktop/windows/index.md) を参照してください。
> また別のクラウドプロビジョニングツールを利用することもできます。
{: .warning }
@z
...
@y
Docker Machine のソースコードはアーカイブされています。
このソースコードは [GitHub](https://github.com/docker/machine){:target="_blank" rel="noopener" class="_"} にあります。
@z
