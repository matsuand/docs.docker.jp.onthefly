...
> **メモ**
>
> Docker Machine は Docker Desktop インストーラーには含まれなくなりました。
> Docker Machine を入手するには GitHub 上の [docker/machine](https://github.com/docker/machine/releases/){: target="_blank" rel="noopener" class="_" } リリースページから個別にダウンロードしてください。
@z
