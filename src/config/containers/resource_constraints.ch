...
| `--cpu-period=<値>`    | CFS スケジューラー間隔を指定します。これは `--cpu-quota` とともに指定されます。デフォルトは 100000 マイクロ秒（100 ミリ秒）です。たいていの場合、このデフォルト値を変更することはしません。Docker 1.13 またはそれ以降の場合は、これではなく`--cpus` を使ってください。                                                                                                                                                                                                                                                                                                                                                                                                                         |
