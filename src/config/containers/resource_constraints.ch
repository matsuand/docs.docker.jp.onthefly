...
| オプション             | 内容説明                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
|:-----------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `-m`または`--memory=`  | コンテナーに割り当てるメモリ最大使用量。このオプションを利用する場合、指定できる最小値は`6m`(6 メガバイト) です。つまり最低でも 6 メガバイトに設定することが必要です。That is, you must set the value to at least 6 megabytes.                                                                                                                                                                                                                              |
