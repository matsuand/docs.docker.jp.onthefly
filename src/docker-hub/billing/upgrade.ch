...
@y
3. **Billing Details** ページの左側において、個人アカウントが選択されていることを確認します。
@z

@x
    ![Billing details personal account](images/billing-personal-account.png){:width="750px"}
@y
    ![料金詳細における個人アカウント](images/billing-personal-account.png){:width="750px"}
@z

@x
4. Click **Change plan** to choose a new plan.
@y
4. **Change plan**（プランの変更）をクリックして新たなプランを選びます。
@z

@x
5. Review the plan details in the **Pro** section and click **Buy Now**.
@y
5. **Pro** セクションにあるプラン詳細を確認して **Buy Now**（今すぐ購入）をクリックします。
@z
...
@y
6. **Payment Method**（お支払い方法）のページにおいて、プロプランへのアップデートにかかる年額料金がデフォルトで示されてます。
...
@y
7. カード情報と表示内容を確認し、**Purchase**（購入）をクリックします。
@z
...
@y
8. 同時にメールアドレスにあてて、古いプランのキャンセル確認が届きます。
@z
...
@y
1. [Docker Hub](https://hub.docker.com){: target="_blank" rel="noopener" class="_"} アカウントでログインします。
2. 画面右上のユーザー名の隣りにあるドロップダウンメニューを開いて、**Billing** を選び **Billing Details**（料金詳細）ページを開きます。このページには、現ユーザーアカウントに関する料金情報が示されています。
3. **Billing Details** ページの左側において、個人アカウントが選択されていることを確認します。
4. **switch to annual billing**（年額プランへの切り替え）をクリックします。
5. **Change to an Annual Plan**（年額プランへの変更）ページにおいて表示される情報を確認し、**Accept Terms and Purchase**（承認と購入）をクリックします。
@z
