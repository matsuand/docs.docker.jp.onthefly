...
@y
- `ipvlan`: IPvlan ネットワークは、IPv4 と IPv6 のアドレッシングが、完全にユーザーにより制御可能となります。
  VLAN ドライバーがその上に構築されているため、アンダーレイネットワーク統合に関心のあるユーザーにとっては、レイヤー 2 VLAN タギングや IPvlan L3 ルーティングでさえ、完全に制御可能としています。
  [IPvlan ネットワーク](ipvlan.md) を参照してください。
@z
