...
- コンテナーの書き込み可能レイヤーにデータを書き込むためには、ファイルシステムを管理する [ストレージドライバー]({{ site.baseurl }}/storage/storagedriver/) が必要になります。
...
- [ストレージドライバー]({{ site.baseurl }}/storage/storagedriver/) について学ぶ。
