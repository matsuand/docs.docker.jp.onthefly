...
@y
[ACI においてサポートされているコンテナー機能の一覧](aci-container-features.md) や [ACI においてサポートされている Compose 機能の一覧](aci-compose-features.md) も参照してください。
@z
...
[ACI においてサポートされているコンテナー機能の一覧](aci-container-features.md) も参照してください。
@z
...
ACI コンテキストの生成には Azure サブスクリプション、[リソースグループ](https://docs.microsoft.com/en-us/azure/azure-resource-manager/management/manage-resource-groups-portal)、地域設定が必要です。
...
@y
[ACI においてサポートされている Compose 機能の一覧](aci-compose-features.md) も参照してください。
@z
